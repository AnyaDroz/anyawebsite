    ...
    <div className={styles.about}>
      <Paragraph>
        <p>
          ...
          with React, Angular, Storybook, Framer... to name a few. This blend of
          user experience and development helps me create business value both at
          the macro level of winning a users’ attention, to the micro level of
          components and consistent, flexible design systems.
        </p>
      </Paragraph>
      <AboutLinks />
    </div>
